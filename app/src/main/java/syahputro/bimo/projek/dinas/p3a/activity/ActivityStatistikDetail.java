            ...
            public void onResponse(Call<ResponseBentuk> call, Response<ResponseBentuk> response) {
                if (response.isSuccessful()) {
                    if (response.body() != null) {
                        ...
                        tv5.setBackground(getResources().getDrawable(R.drawable.table_header_border));
                        tbrow0.addView(tv5);
                        TextView tv6 = new TextView(getApplicationContext());
                        tv6.setText(" Penelantaran ");
                        tv6.setTextColor(Color.BLACK);
                        tv6.setBackground(getResources().getDrawable(R.drawable.table_header_border));
                        tbrow0.addView(tv6);
                        TextView tv7 = new TextView(getApplicationContext());
                        tv7.setText(" Lain ");
                        tv7.setTextColor(Color.BLACK);
                        tv7.setBackground(getResources().getDrawable(R.drawable.table_header_border));
                        tbrow0.addView(tv7);
